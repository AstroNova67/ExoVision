...
def initialize_models():
    ...
    try:
        ...
        tess_dataset_path = os.path.join(
            os.path.dirname(__file__), "datasets", "filtered_features_k2pandc.csv"
        )
        tess_model = TESS(tess_dataset_path)
        tess_model.load_model()
        print("TESS model loaded successfully!")
